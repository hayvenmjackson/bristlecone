...
(function () {
  const en = {
    ...
    'base.satellite.d': "Aerial photos with roads and labels. US: USGS 1 m. Canada: Sentinel-2.",
    'rec.title': "Record a hike",
    'rec.intro': "Bristlecone records your route, distance, climb and steps, even with the screen off. You can share it or save it to Health Connect afterward.",
    'rec.battery': "Recording uses GPS continuously. A full day usually takes a third to half of a phone battery.",
    'rec.start': "Start recording",
    'rec.pause': "Pause",
    'rec.resume': "Resume",
    'rec.stop': "Finish",
    'rec.notifTitle': "Bristlecone is recording your hike",
    'rec.notifText': "Tap to see your route and stats.",
    'rec.tooShort': "Too short to save. Nothing was recorded.",
    'rec.defaultName': "Hike near {place}, {date}",
    'rec.hike': "Recorded hike",
    'rec.hikes': "Your hikes",
    'rec.distance': "Distance",
    'rec.moving': "Moving time",
    'rec.elapsed': "Total time",
    'rec.climb': "Climb",
    'rec.steps': "Steps",
    'rec.gpsClimb': "Climb measured by GPS altitude (this phone has no barometer), so treat it as approximate.",
    'rec.shareCard': "Share route card",
    'rec.shareGpx': "Share GPX",
    'rec.deleteConfirm': "Tap again to delete this hike",
    'rec.caption': "{name}: {dist}, {gain} of climbing, {time} moving. Recorded with Bristlecone.",
    'rec.textLocation': "Text my location",
    'rec.smsBody': "I am here: {coords} (within {acc}) at {time}. Map: {link}",
    'rec.smsEstimate': "My estimated position (no GPS right now): {coords}, give or take {acc}, at {time}. Map: {link}",
    'health.save': "Save to Health Connect",
    'health.synced': "Saved to Health Connect",
    'health.done': "Saved to Health Connect.",
    'health.denied': "Health Connect access was not allowed. You can change this in Android settings under Health Connect.",
    'health.needs14': "Health Connect needs Android 14 or newer. You can still share the GPX file with Strava, Garmin Connect and others.",
    'health.privacyTitle': "Bristlecone and Health Connect",
    'health.privacyBody': "Bristlecone only writes to Health Connect, and only the hikes you choose to save: that it was a hike, the start and end time, the route, distance, elevation gained and steps. It never reads your health data. Nothing is sent anywhere else.",
    'soc.title': "Trail reports from social posts",
    'soc.intro': "Public posts from Mastodon-compatible servers, checked on this phone. Only first-hand reports about trail conditions are shown; everything else is set aside.",
    'soc.enable': "Include social trail reports",
    'soc.add': "Add server",
    'soc.useful': "Useful",
    'soc.notReport': "Not a trail report",
    'soc.thanks': "Thanks. Bristlecone will pick out reports like this one.",
    'soc.learned': "The filter has learned from {n} of your answers.",
    'soc.reset': "Reset what the filter learned",
    'soc.off': "turned off",
    'src.social': "Trail reports (social)",
    'td.open': "Trail details",
    'td.working': "Measuring the trail…",
    'td.failed': "Could not load trail details. Try again with a connection.",
    'td.level.easy': "Easy",
    'td.level.moderate': "Moderate",
    'td.level.hard': "Hard",
    'td.level.veryhard': "Very Hard",
    'td.level.expert': "Expert Only",
    'td.level.unknown': "Not rated",
    'td.how': "How ratings work",
    'td.howBody': "Ratings run from Easy to Expert Only. Technical difficulty comes from OpenStreetMap tags (the SAC hiking scale, via ferrata, ladders, marked hazards, trail visibility) and from warnings in official descriptions, such as iron rungs or exposed ledges. Physical effort uses the Shenandoah National Park formula: the square root of (climb in feet x 2 x round-trip miles). Effort alone can make a trail Very Hard, but only exposure or technical terrain makes it Expert Only. Every reason is listed with the rating. Check current conditions before you go.",
    'td.why.sac': "Mapped difficulty: {grade}",
    'td.why.ferrata': "Includes a via ferrata section (fixed cables or rungs)",
    'td.why.ladder': "Includes ladders",
    'td.why.hazard': "Marked hazard: {hazard}",
    'td.why.visibility': "Parts of the trail are hard to follow",
    'td.why.text': "{source} description mentions \"{phrase}\"",
    'td.why.effort': "Effort score {score} (distance and climb)",
    'td.why.grade': "Steepest sustained section about {pct}% grade",
    'td.noTech': "Technical difficulty is not recorded for this trail, so the rating reflects distance and climb only.",
    'td.length': "Length",
    'td.loop': "(loop)",
    'td.oneWay': "(one way)",
    'td.roundTrip': "Out and back",
    'td.high': "High point",
    'td.steepest': "Steepest section",
    'td.time': "Typical time",
    'td.timeNote': "(Naismith’s rule)",
    'td.rating': "Rating",
    'td.profile': "Elevation profile",
    'td.dataNote': "Measured from OpenStreetMap trail lines and public elevation data (about 30 m resolution).",
    'td.toStart': "Directions to the start",
    'td.about': "About this trail",
    'td.noDesc': "No published description found for this trail.",
    'td.photos': "Photos",
    'td.photoNote': "Photos taken near this trail, from the National Park Service and Wikimedia Commons, with their photographers credited.",
    'td.noPhotos': "No public photos found near here.",
    'td.noParking': "No mapped parking found near the start.",
    'td.parkingLot': "Parking",
    'td.spaces': "{n} spaces",
    'td.free': "Free",
    'td.fromStart': "from the start",
    'td.fromHere': "Trails from here",
    'td.noTrailsHere': "No named trails mapped from this trailhead yet.",
    'td.caption': "{name}. Mapped with Bristlecone.",
    'reg.region': "Region",
    'reg.sub': "Named trails in this area",
    'reg.loading': "Finding trails…",
    'reg.failed': "Could not load the trail list. Try again with a connection.",
    'reg.none': "No named trails found here.",
    'reg.count': "{n} trails, major routes first",
    'reg.notable': "Well known",
    'reg.national': "National trail",
    'reg.regional': "Regional trail",
    'reg.trailsIn': "Trails in this region",
    'reg.trail': "Trail",
    'reg.zoomed': "Showing {name}. Tap the trail for details.",
  ...
  const fr = {
    ...
    'base.satellite': "Satellite",
    'base.satellite.d': "Photos aériennes avec routes et étiquettes. É.-U. : USGS 1 m. Canada : Sentinel-2.",
    'rec.title': "Enregistrer une randonnée",
    'rec.intro': "Bristlecone enregistre votre tracé, la distance, le dénivelé et vos pas, même écran éteint. Vous pourrez ensuite le partager ou l’enregistrer dans Health Connect.",
    'rec.battery': "L’enregistrement utilise le GPS en continu. Une journée complète consomme en général du tiers à la moitié de la batterie.",
    'rec.start': "Commencer",
    'rec.pause': "Pause",
    'rec.resume': "Reprendre",
    'rec.stop': "Terminer",
    'rec.notifTitle': "Bristlecone enregistre votre randonnée",
    'rec.notifText': "Touchez pour voir le tracé et les statistiques.",
    'rec.tooShort': "Trop court pour être enregistré.",
    'rec.defaultName': "Randonnée près de {place}, {date}",
    'rec.hike': "Randonnée enregistrée",
    'rec.hikes': "Vos randonnées",
    'rec.distance': "Distance",
    'rec.moving': "Temps en mouvement",
    'rec.elapsed': "Temps total",
    'rec.climb': "Dénivelé",
    'rec.steps': "Pas",
    'rec.gpsClimb': "Dénivelé mesuré par l’altitude GPS (ce téléphone n’a pas de baromètre); c’est une approximation.",
    'rec.shareCard': "Partager la carte du tracé",
    'rec.shareGpx': "Partager le GPX",
    'rec.deleteConfirm': "Touchez de nouveau pour supprimer",
    'rec.caption': "{name} : {dist}, {gain} de dénivelé, {time} en mouvement. Enregistré avec Bristlecone.",
    'rec.textLocation': "Envoyer ma position par texto",
    'rec.smsBody': "Je suis ici : {coords} (à {acc} près) à {time}. Carte : {link}",
    'rec.smsEstimate': "Ma position estimée (pas de GPS en ce moment) : {coords}, à {acc} près, à {time}. Carte : {link}",
    'health.save': "Enregistrer dans Health Connect",
    'health.synced': "Enregistré dans Health Connect",
    'health.done': "Enregistré dans Health Connect.",
    'health.denied': "L’accès à Health Connect n’a pas été autorisé. Vous pouvez le modifier dans les réglages Android, sous Health Connect.",
    'health.needs14': "Health Connect exige Android 14 ou plus récent. Vous pouvez tout de même partager le fichier GPX avec Strava, Garmin Connect et d’autres.",
    'health.privacyTitle': "Bristlecone et Health Connect",
    'health.privacyBody': "Bristlecone ne fait qu’écrire dans Health Connect, et seulement les randonnées que vous choisissez d’enregistrer : le type d’activité, l’heure de début et de fin, le tracé, la distance, le dénivelé et les pas. Il ne lit jamais vos données de santé. Rien n’est envoyé ailleurs.",
    'soc.title': "Rapports de sentier publiés en ligne",
    'soc.intro': "Publications publiques de serveurs compatibles avec Mastodon, triées sur ce téléphone. Seuls les rapports de première main sur l’état des sentiers sont affichés; le reste est écarté.",
    'soc.enable': "Inclure les rapports publiés en ligne",
    'soc.add': "Ajouter un serveur",
    'soc.useful': "Utile",
    'soc.notReport': "Pas un rapport de sentier",
    'soc.thanks': "Merci. Bristlecone retiendra les rapports de ce genre.",
    'soc.learned': "Le filtre a appris de {n} de vos réponses.",
    'soc.reset': "Réinitialiser l’apprentissage du filtre",
    'soc.off': "désactivé",
    'src.social': "Rapports de sentier (en ligne)",
    'td.open': "Détails du sentier",
    'td.working': "Mesure du sentier…",
    'td.failed': "Impossible de charger les détails. Réessayez avec une connexion.",
    'td.level.easy': "Facile",
    'td.level.moderate': "Modéré",
    'td.level.hard': "Difficile",
    'td.level.veryhard': "Très difficile",
    'td.level.expert': "Experts seulement",
    'td.level.unknown': "Non coté",
    'td.how': "Comment fonctionnent les cotes",
    'td.howBody': "Les cotes vont de Facile à Experts seulement. La difficulté technique provient des attributs OpenStreetMap (échelle de randonnée CAS, via ferrata, échelles, dangers signalés, visibilité du sentier) et des avertissements des descriptions officielles, comme des barreaux de fer ou des corniches exposées. L’effort physique utilise la formule du parc national Shenandoah : la racine carrée de (dénivelé en pieds x 2 x milles aller-retour). L’effort seul peut rendre un sentier Très difficile, mais seules l’exposition ou un terrain technique le rendent Experts seulement. Chaque raison accompagne la cote. Vérifiez les conditions actuelles avant de partir.",
    'td.why.sac': "Difficulté cartographiée : {grade}",
    'td.why.ferrata': "Comprend une section de via ferrata (câbles ou barreaux fixes)",
    'td.why.ladder': "Comprend des échelles",
    'td.why.hazard': "Danger signalé : {hazard}",
    'td.why.visibility': "Certaines parties du sentier sont difficiles à suivre",
    'td.why.text': "La description ({source}) mentionne « {phrase} »",
    'td.why.effort': "Indice d’effort {score} (distance et dénivelé)",
    'td.why.grade': "Section soutenue la plus raide : environ {pct} %",
    'td.noTech': "La difficulté technique n’est pas cartographiée pour ce sentier; la cote tient compte seulement de la distance et du dénivelé.",
    'td.length': "Longueur",
    'td.loop': "(boucle)",
    'td.oneWay': "(aller simple)",
    'td.roundTrip': "Aller-retour",
    'td.high': "Point culminant",
    'td.steepest': "Section la plus raide",
    'td.time': "Durée habituelle",
    'td.timeNote': "(règle de Naismith)",
    'td.rating': "Cote",
    'td.profile': "Profil d’altitude",
    'td.dataNote': "Mesuré à partir des tracés OpenStreetMap et de données d’altitude publiques (résolution d’environ 30 m).",
    'td.toStart': "Itinéraire jusqu’au départ",
    'td.about': "À propos de ce sentier",
    'td.noDesc': "Aucune description publiée trouvée pour ce sentier.",
    'td.photos': "Photos",
    'td.photoNote': "Photos prises près de ce sentier, du National Park Service et de Wikimedia Commons, avec le nom des photographes.",
    'td.noPhotos': "Aucune photo publique trouvée près d’ici.",
    'td.noParking': "Aucun stationnement cartographié près du départ.",
    'td.parkingLot': "Stationnement",
    'td.spaces': "{n} places",
    'td.free': "Gratuit",
    'td.fromStart': "du départ",
    'td.fromHere': "Sentiers au départ d’ici",
    'td.noTrailsHere': "Aucun sentier nommé cartographié depuis ce point de départ.",
    'td.caption': "{name}. Cartographié avec Bristlecone.",
    'reg.region': "Région",
    'reg.sub': "Sentiers nommés dans ce secteur",
    'reg.loading': "Recherche des sentiers…",
    'reg.failed': "Impossible de charger la liste. Réessayez avec une connexion.",
    'reg.none': "Aucun sentier nommé trouvé ici.",
    'reg.count': "{n} sentiers, les grands itinéraires d’abord",
    'reg.notable': "Bien connu",
    'reg.national': "Sentier national",
    'reg.regional': "Sentier régional",
    'reg.trailsIn': "Sentiers de cette région",
    'reg.trail': "Sentier",
    'reg.zoomed': "Voici {name}. Touchez le sentier pour les détails.",
  ...
  const es = {
    ...
    'base.satellite': "Satélite",
    'base.satellite.d': "Fotos aéreas con caminos y etiquetas. EE. UU.: USGS 1 m. Canadá: Sentinel-2.",
    'rec.title': "Grabar una caminata",
    'rec.intro': "Bristlecone graba tu ruta, distancia, desnivel y pasos, incluso con la pantalla apagada. Después puedes compartirla o guardarla en Health Connect.",
    'rec.battery': "La grabación usa el GPS todo el tiempo. Un día completo suele gastar entre un tercio y la mitad de la batería.",
    'rec.start': "Empezar a grabar",
    'rec.pause': "Pausa",
    'rec.resume': "Reanudar",
    'rec.stop': "Terminar",
    'rec.notifTitle': "Bristlecone está grabando tu caminata",
    'rec.notifText': "Toca para ver tu ruta y estadísticas.",
    'rec.tooShort': "Demasiado corta para guardarla.",
    'rec.defaultName': "Caminata cerca de {place}, {date}",
    'rec.hike': "Caminata grabada",
    'rec.hikes': "Tus caminatas",
    'rec.distance': "Distancia",
    'rec.moving': "Tiempo en movimiento",
    'rec.elapsed': "Tiempo total",
    'rec.climb': "Desnivel",
    'rec.steps': "Pasos",
    'rec.gpsClimb': "Desnivel medido con la altitud del GPS (este teléfono no tiene barómetro); tómalo como aproximado.",
    'rec.shareCard': "Compartir tarjeta de la ruta",
    'rec.shareGpx': "Compartir GPX",
    'rec.deleteConfirm': "Toca otra vez para eliminar",
    'rec.caption': "{name}: {dist}, {gain} de desnivel, {time} en movimiento. Grabado con Bristlecone.",
    'rec.textLocation': "Enviar mi ubicación por SMS",
    'rec.smsBody': "Estoy aquí: {coords} (con {acc} de margen) a las {time}. Mapa: {link}",
    'rec.smsEstimate': "Mi posición estimada (sin GPS ahora): {coords}, con unos {acc} de margen, a las {time}. Mapa: {link}",
    'health.save': "Guardar en Health Connect",
    'health.synced': "Guardado en Health Connect",
    'health.done': "Guardado en Health Connect.",
    'health.denied': "No se permitió el acceso a Health Connect. Puedes cambiarlo en los ajustes de Android, en Health Connect.",
    'health.needs14': "Health Connect requiere Android 14 o más reciente. Aun así puedes compartir el archivo GPX con Strava, Garmin Connect y otros.",
    'health.privacyTitle': "Bristlecone y Health Connect",
    'health.privacyBody': "Bristlecone solo escribe en Health Connect, y solo las caminatas que decides guardar: el tipo de actividad, la hora de inicio y fin, la ruta, la distancia, el desnivel y los pasos. Nunca lee tus datos de salud. No se envía nada a ningún otro lugar.",
    'soc.title': "Reportes de senderos en redes",
    'soc.intro': "Publicaciones públicas de servidores compatibles con Mastodon, revisadas en este teléfono. Solo se muestran reportes de primera mano sobre el estado de los senderos; lo demás se descarta.",
    'soc.enable': "Incluir reportes de redes",
    'soc.add': "Agregar servidor",
    'soc.useful': "Útil",
    'soc.notReport': "No es un reporte de sendero",
    'soc.thanks': "Gracias. Bristlecone buscará reportes como este.",
    'soc.learned': "El filtro ha aprendido de {n} de tus respuestas.",
    'soc.reset': "Restablecer lo que aprendió el filtro",
    'soc.off': "desactivado",
    'src.social': "Reportes de senderos (redes)",
    'td.open': "Detalles del sendero",
    'td.working': "Midiendo el sendero…",
    'td.failed': "No se pudieron cargar los detalles. Inténtalo de nuevo con conexión.",
    'td.level.easy': "Fácil",
    'td.level.moderate': "Moderado",
    'td.level.hard': "Difícil",
    'td.level.veryhard': "Muy difícil",
    'td.level.expert': "Solo expertos",
    'td.level.unknown': "Sin clasificar",
    'td.how': "Cómo se clasifican",
    'td.howBody': "La clasificación va de Fácil a Solo expertos. La dificultad técnica viene de las etiquetas de OpenStreetMap (escala de senderismo SAC, vía ferrata, escaleras, peligros marcados, visibilidad del sendero) y de las advertencias en descripciones oficiales, como peldaños de hierro o cornisas expuestas. El esfuerzo físico usa la fórmula del Parque Nacional Shenandoah: la raíz cuadrada de (desnivel en pies x 2 x millas de ida y vuelta). El esfuerzo por sí solo puede hacer un sendero Muy difícil, pero solo la exposición o el terreno técnico lo hacen Solo expertos. Cada razón aparece junto a la clasificación. Revisa las condiciones actuales antes de salir.",
    'td.why.sac': "Dificultad cartografiada: {grade}",
    'td.why.ferrata': "Incluye un tramo de vía ferrata (cables o peldaños fijos)",
    'td.why.ladder': "Incluye escaleras",
    'td.why.hazard': "Peligro marcado: {hazard}",
    'td.why.visibility': "Algunas partes del sendero son difíciles de seguir",
    'td.why.text': "La descripción de {source} menciona \"{phrase}\"",
    'td.why.effort': "Índice de esfuerzo {score} (distancia y desnivel)",
    'td.why.grade': "Tramo sostenido más empinado: cerca de {pct} %",
    'td.noTech': "La dificultad técnica no está registrada para este sendero, así que la clasificación refleja solo distancia y desnivel.",
    'td.length': "Longitud",
    'td.loop': "(circuito)",
    'td.oneWay': "(solo ida)",
    'td.roundTrip': "Ida y vuelta",
    'td.high': "Punto más alto",
    'td.steepest': "Tramo más empinado",
    'td.time': "Tiempo habitual",
    'td.timeNote': "(regla de Naismith)",
    'td.rating': "Clasificación",
    'td.profile': "Perfil de elevación",
    'td.dataNote': "Medido con las líneas de senderos de OpenStreetMap y datos públicos de elevación (resolución de unos 30 m).",
    'td.toStart': "Cómo llegar al inicio",
    'td.about': "Sobre este sendero",
    'td.noDesc': "No se encontró una descripción publicada de este sendero.",
    'td.photos': "Fotos",
    'td.photoNote': "Fotos tomadas cerca de este sendero, del Servicio de Parques Nacionales y de Wikimedia Commons, con el crédito de sus fotógrafos.",
    'td.noPhotos': "No se encontraron fotos públicas cerca.",
    'td.noParking': "No hay estacionamiento cartografiado cerca del inicio.",
    'td.parkingLot': "Estacionamiento",
    'td.spaces': "{n} lugares",
    'td.free': "Gratis",
    'td.fromStart': "desde el inicio",
    'td.fromHere': "Senderos desde aquí",
    'td.noTrailsHere': "Aún no hay senderos con nombre cartografiados desde este inicio.",
    'td.caption': "{name}. Cartografiado con Bristlecone.",
    'reg.region': "Región",
    'reg.sub': "Senderos con nombre en esta zona",
    'reg.loading': "Buscando senderos…",
    'reg.failed': "No se pudo cargar la lista. Inténtalo de nuevo con conexión.",
    'reg.none': "No se encontraron senderos con nombre aquí.",
    'reg.count': "{n} senderos, primero las rutas principales",
    'reg.notable': "Muy conocido",
    'reg.national': "Sendero nacional",
    'reg.regional': "Sendero regional",
    'reg.trailsIn': "Senderos de esta región",
    'reg.trail': "Sendero",
    'reg.zoomed': "Mostrando {name}. Toca el sendero para ver detalles.",
